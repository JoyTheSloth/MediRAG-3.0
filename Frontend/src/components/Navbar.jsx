        ...
        <nav className="navbar" id="navbar">
            <div className="nav-container">
                ...
                <div className="nav-right">
                    ...
                    {/* Mobile-only hamburger for extra pages */}
                    <button
            ...
            {isMobileMenuOpen && (
                <div className="mobile-dropdown-menu">
                    <NavLink to="/api-agent" className={({ isActive }) => (isActive ? 'mob-drop-link active' : 'mob-drop-link')}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
                            <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                        </svg>
                        API Agent
                    </NavLink>
                    <NavLink to="/research" className={({ isActive }) => (isActive ? 'mob-drop-link active' : 'mob-drop-link')}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18">
                            <circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                        </svg>
                        Research
                    </NavLink>
                    <a href="https://github.com/JoyTheSloth/MediRAG" className="mob-drop-link" target="_blank" rel="noopener noreferrer">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
                            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                        </svg>
                        GitHub ↗
                    </a>
                    <Link to="/console" className="mob-drop-cta">
                        Run Evaluation →
                    </Link>
                </div>
            )}
