    ...
    <>
      ...
      <main>
        <Routes>
            ...
            <Route path="/chat" element={<MediChat engineConfig={{ apiUrl: process.env.REACT_APP_API_URL || 'http://localhost:8000', provider: 'Mistral', apiKey: 'UNWuD4qMgZeZAVdcAiC2dsuZwGFr9IE0', model: 'mistral-large-latest', topK: 5, runRagas: false }} />} />
        </Routes>
      </main>
